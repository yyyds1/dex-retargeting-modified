...
# # # # os.system("export PATH=$PATH:/home/hz/anaconda3/envs/dexmo/bin/pyside2-uic")
# # # # export PATH=/path/to/usd/bin:$PATH
...
# # #     # 导入OBJ文件
# # #     UsdGeom.Mesh.Import(obj_path, xform.GetPrim())
...
# # # # 使用示例
# # # convert_obj_to_usd("/home/hz/Downloads/dataset/models/007_tuna_fish_can/textured_simple.obj", "output.usd")
